...
class QueGenerator():
  def __init__(self,threshold=0.75, model_dir=None):
    '''
    ...
    self.que_model = T5ForConditionalGeneration.from_pretrained('/Users/philipcheng/Documents/models/t5_que_gen/t5_que_gen_model/t5_base_que_gen/')
    self.ans_model = T5ForConditionalGeneration.from_pretrained('/Users/philipcheng/Documents/models/t5_que_gen/t5_ans_gen_model/t5_base_ans_gen/')
    self.qa_model = DistilBertForQuestionAnswering.from_pretrained('/Users/philipcheng/Documents/models/distilbert-qa')
    
    self.que_tokenizer = T5Tokenizer.from_pretrained('/Users/philipcheng/Documents/models/t5_que_gen/t5_que_gen_model/t5_base_tok_que_gen/')
    self.ans_tokenizer = T5Tokenizer.from_pretrained('/Users/philipcheng/Documents/models/t5_que_gen/t5_ans_gen_model/t5_base_tok_ans_gen/')
...
qg.generate(text_example)
# %%
source_text_df = pandas.read_csv('/Users/philipcheng/Desktop/summarize.csv')
source_text_df.head()

# %%
for index,row in source_text_df.iterrows():
    output = qg.generate(row['content'])
    s = ""
    for aq_pairs in output:
        s = s+aq_pairs['question'] + "  " + aq_pairs['answer']
        s = s+"\n"
    row['content'] = s
...
# %%
source_text_df.to_csv('/Users/philipcheng/Desktop/qg.csv',index=False)
