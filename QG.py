...
class QueGenerator():
  def __init__(self,model_dir,threshold=0.75):
    '''
    ...
    self.que_model = T5ForConditionalGeneration.from_pretrained(self._dir+'/t5_que_gen/t5_que_gen_model/t5_base_que_gen/')
    self.ans_model = T5ForConditionalGeneration.from_pretrained(self._dir+'/t5_que_gen/t5_ans_gen_model/t5_base_ans_gen/')
    self.qa_model = DistilBertForQuestionAnswering.from_pretrained('distilbert-base-cased-distilled-squad')
    
    self.que_tokenizer = T5Tokenizer.from_pretrained(self._dir+'/t5_que_gen/t5_que_gen_model/t5_base_tok_que_gen/')
    self.ans_tokenizer = T5Tokenizer.from_pretrained(self._dir+'/t5_que_gen/t5_ans_gen_model/t5_base_tok_ans_gen/')
